...
<head>
        ...
        <title>App Development - NavMake</title>
        <meta name="description" content="App Development - NavMake">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-7 col-lg-8">
                            <div class="section-title text-center mb-65">
                                <h2 class="title">Explore Our Mobile App Solutions</h2>
                                <p>Discover a world of innovative mobile applications tailored to enhance your digital experience. From social networking to productivity tools, we offer a diverse range of solutions designed to meet your specific needs.</p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-10">
                                <div class="services-item-five">
                                    <div class="services-icon-five">
                                        <img src="assets/img/icon/app-development.png" alt="">
                                    </div>
                                    <div class="services-content-five">
                                        <h2 class="title"><a >E-commerce <span>Apps</span></a></h2>
                                        <p>Mobile platforms for buying and selling products or services online, such as Amazon, eBay, Alibaba, and Shopify.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-10">
                                <div class="services-item-five">
                                    ...
                                    <div class="services-content-five">
                                        <h2 class="title"><a >Health and Fitness <span>Apps</span></a></h2>
                                        <p>Mobile platforms for tracking health metrics, exercise routines, nutrition, and wellness goals, such as Fitbit, MyFitnessPal, Strava, and Headspace.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-10">
                                <div class="services-item-five">
                                 ...
                                 <img src="assets/img/icon/app-development.png" alt="">
                                    ...
                                    <div class="services-content-five">
                                        <h2 class="title"><a >Food Delivery <span>Apps</span></a></h2>
                                        <p>Applications for ordering food from restaurants, cafes, and food delivery services, such as Uber Eats, DoorDash, Grubhub, and Postmates.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-10">
                                <div class="services-item-five">
                                 ...
                                 <img src="assets/img/icon/app-development.png" alt="">
                                    ...
                                    <div class="services-content-five">
                                        <h2 class="title"><a >Dating <span>Apps</span></a></h2>
                                        <p>Platforms for meeting new people, socializing, and forming romantic connections, such as Tinder, Bumble, OkCupid, and Hinge.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-10">
                                <div class="services-item-five">
                                   ...
                                   <img src="assets/img/icon/app-development.png" alt="">
                                    ...
                                    <div class="services-content-five">
                                        <h2 class="title"><a >Education <span>Apps</span></a></h2>
                                        <p>Mobile platforms for learning and educational purposes, including language learning apps, online courses, and educational games, such as Duolingo, Khan Academy, and Quizlet.</p>
                                    </div>
                                </div>
                            </div>
                             <div class="col-xl-3 col-lg-3 col-md-6 col-sm-10">
                                <div class="services-item-five">
                                    ...
                                    <div class="services-content-five">
                                        <h2 class="title"><a >Travel and Navigation <span>Apps</span></a></h2>
                                        <p>Applications for planning trips, booking accommodations, finding directions, and navigating unfamiliar places, including Google Maps, Airbnb, Uber, and TripAdvisor.</p>
                                    </div>
                                </div>
                            </div>
