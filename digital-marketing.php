...
<head>
        ...
        <title>Digital Marketing - NavMake</title>
        <meta name="description" content="Digital Marketing - NavMake">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-7 col-lg-8">
                            <div class="section-title text-center mb-65">
                                <h2 class="title">Discover Digital Marketing Solutions</h2>
                                <p>Unlock the power of digital marketing with our comprehensive range of strategies tailored to elevate your brand's online presence and drive results.</p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-10">
                                <div class="services-item-five">
                                    <div class="services-icon-five">
                                        <img src="assets/img/icon/bullhorn.png" alt="">
                                    </div>
                                    <div class="services-content-five">
                                        <h2 class="title"><a >Search Engine Optimization<span>(SEO)</span></a></h2>
                                        <p>Optimizing your website to rank higher in search engine results pages (SERPs) organically, driving organic traffic and increasing visibility.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-10">
                                <div class="services-item-five">
                                    ...
                                    <div class="services-content-five">
                                        <h2 class="title"><a >Search Engine Marketing <span>(SEM)</span></a></h2>
                                        <p>Running paid advertising campaigns on search engines like Google or Bing, often using pay-per-click (PPC) ads to increase visibility and drive targeted traffic.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-10">
                                <div class="services-item-five">
                                    ...
                                    <div class="services-content-five">
                                        <h2 class="title"><a >Content Marketing <span></span></a></h2>
                                        <p>Creating and distributing valuable, relevant, and consistent content to attract and engage a target audience, with the goal of driving profitable customer action.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-10">
                                <div class="services-item-five">
                                    ...
                                    <div class="services-content-five">
                                        <h2 class="title"><a >Social Media Marketing <span>(SMM)</span></a></h2>
                                        <p>Promoting your brand, products, or services on social media platforms like Facebook, Instagram, Twitter, LinkedIn, and TikTok to increase brand awareness, engagement, and conversions.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-10">
                                <div class="services-item-five">
                                    ...
                                    <div class="services-content-five">
                                        <h2 class="title"><a >Email Marketing <span></span></a></h2>
                                        <p>Sending targeted emails to a list of subscribers or customers to promote products, share updates, nurture leads, and build relationships, often using newsletters, promotional emails, and automated email campaigns.</p>
                                    </div>
                                </div>
                            </div>
                             <div class="col-xl-3 col-lg-3 col-md-6 col-sm-10">
                                <div class="services-item-five">
                                    ...
                                    <div class="services-content-five">
                                        <h2 class="title"><a >Mobile Marketing <span></span></a></h2>
                                        <p>Targeting users on mobile devices with ads, promotions, and campaigns optimized for mobile platforms, including mobile apps, websites, and messaging apps.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-10">
                                <div class="services-item-five">
                                    ...
                                    <div class="services-content-five">
                                        <h2 class="title"><a >Experiential Marketing <span></span></a></h2>
                                        <p>Creating memorable and immersive brand experiences through interactive events, pop-up shops, product demonstrations, and experiential activations to engage customers and drive brand affinity.</p>
                                    </div>
                                </div>
                            </div>
