...
<head>
        ...
        <title>Web Development - NavMake</title>
        <meta name="description" content="Web Development - NavMake">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-7 col-lg-8">
                            <div class="section-title text-center mb-65">
                                <h2 class="title">Explore Our Web Solutions</h2>
                                <p>Discover a plethora of custom web solutions tailored to meet your specific needs and elevate your online presence.</p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-10">
                                <div class="services-item-five">
                                    ...
                                    <div class="services-content-five">
                                        <h2 class="title"><a >Business <span>Website</span></a></h2>
                                        <p>Designed for businesses to showcase their products or services and provide information about their company.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-10">
                                <div class="services-item-five">
                                    ...
                                    <div class="services-content-five">
                                        <h2 class="title"><a >E-Commerce <span>Website</span></a></h2>
                                        <p>Online stores where users can browse and purchase products or services.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-10">
                                <div class="services-item-five">
                                    ...
                                    <div class="services-content-five">
                                        <h2 class="title"><a >Portfolio <span>Webiste</span></a></h2>
                                        <p>Showcases the work, projects, or skills of an individual or a company, often used by creatives like designers, photographers, or artists.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-10">
                                <div class="services-item-five">
                                 ...
                                 <img src="assets/img/icon/web.png" alt="">
                                    ...
                                    <div class="services-content-five">
                                        <h2 class="title"><a >Personal <span>Website</span></a></h2>
                                        <p> Platforms for individuals to share their thoughts, ideas, or expertise on various topics.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-10">
                                <div class="services-item-five">
                                    ...
                                    <div class="services-content-five">
                                        <h2 class="title"><a >Educational <span>Website</span></a></h2>
                                        <p> Platforms for educational institutions, online courses, or e-learning materials.</p>
                                    </div>
                                </div>
                            </div>
                             <div class="col-xl-3 col-lg-3 col-md-6 col-sm-10">
                              ...
                              <img src="assets/img/icon/web.png" alt="">
                                    ...
                                    <div class="services-content-five">
                                        <h2 class="title"><a >Social Networking <span>Website</span></a></h2>
                                        <p>Platforms that allow users to connect and interact with each other, share content, and build communities.</p>
                                    </div>
                                </div>
                            </div>
                             <div class="col-xl-3 col-lg-3 col-md-6 col-sm-10">
                                <div class="services-item-five">
                                    ...
                                    <div class="services-content-five">
                                        <h2 class="title"><a >Government <span>Website</span></a></h2>
                                        <p>Websites for government agencies or departments to provide information and services to the public.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-10">
                                <div class="services-item-five">
                                    ...
                                    <div class="services-content-five">
                                        <h2 class="title"><a >Travel <span>Website</span></a></h2>
                                        <p>Platforms for booking flights, hotels, or vacation packages, and providing travel-related information and resources.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-10">
                                <div class="services-item-five">
                                    ...
                                    <div class="services-content-five">
                                        <h2 class="title"><a >Event <span>Website</span></a></h2>
                                        <p>Websites for promoting and managing events, conferences, or festivals, including ticket sales and event schedules.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
