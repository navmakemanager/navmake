...
<head>
        ...
        <title>Branding Design - NavMake</title>
        <meta name="description" content="Branding Design - NavMake">
                            ...
                            <div class="breadcrumb-content">
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Branding Design</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-7 col-lg-8">
                            <div class="section-title text-center mb-65">
                                <h2 class="title">Explore Branding Design Solutions</h2>
                                <p>Discover our comprehensive suite of branding design services tailored to elevate your brand's identity and captivate your audience.</p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-10">
                                <div class="services-item-five">
                                    ...
                                    <div class="services-content-five">
                                        <h2 class="title"><a >Logo Design<span></span></a></h2>
                                        <p>Creating a unique symbol or graphic representation that represents a brand's identity and values.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-10">
                                <div class="services-item-five">
                                    ...
                                    <div class="services-content-five">
                                        <h2 class="title"><a >Brand Identity Design<span></span></a></h2>
                                        <p>Developing a cohesive visual identity system that includes logos, color palettes, typography, and imagery to communicate the brand's personality consistently across all channels.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-10">
                                <div class="services-item-five">
                                   ...
                                   <img src="assets/img/icon/palette.png" alt="">
                                    ...
                                    <div class="services-content-five">
                                        <h2 class="title"><a >Packaging Design <span></span></a></h2>
                                        <p>Designing the packaging for products to attract consumers' attention, communicate brand values, and differentiate the product from competitors.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-10">
                             ...
                             <img src="assets/img/icon/palette.png" alt="">
                                    ...
                                    <div class="services-content-five">
                                        <h2 class="title"><a >Social Media Graphics <span>(SMG)</span></a></h2>
                                        <p>Designing visual assets such as profile pictures, cover photos, posts, and advertisements for social media platforms to maintain brand consistency and attract audience engagement.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-10">
                                <div class="services-item-five">
                                    ...
                                    <div class="services-content-five">
                                        <h2 class="title"><a >Branded Merchandise Design <span></span></a></h2>
                                        <p>Designing promotional items and merchandise such as apparel, accessories, and stationery to promote the brand and enhance brand loyalty.</p>
                                    </div>
                                </div>
                            </div>
                             <div class="col-xl-3 col-lg-3 col-md-6 col-sm-10">
                                <div class="services-item-five">
                                   ...
                                   <img src="assets/img/icon/palette.png" alt="">
                                    ...
                                    <div class="services-content-five">
                                        <h2 class="title"><a >Brand Messaging and Copywriting <span></span></a></h2>
                                        <p>Crafting the brand's messaging, taglines, and copywriting to communicate its values, benefits, and unique selling propositions effectively.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-10">
                                <div class="services-item-five">
                                  ...
                                  <img src="assets/img/icon/palette.png" alt="">
                                    ...
                                    <div class="services-content-five">
                                        <h2 class="title"><a >Print Collateral <span></span></a></h2>
                                        <p>Designing printed materials such as business cards, letterheads, brochures, flyers, and posters to reinforce the brand's identity and messaging.</p>
                                    </div>
                                </div>
                            </div>
